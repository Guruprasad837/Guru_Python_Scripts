...
input_file_path = os.path.join(output_directory, r'C:\Users\mgg3kor\Downloads\Natesh_cariad_remaining.xlsx') #Customer file
...
file2_path = os.path.join(output_directory, r'C:\Users\mgg3kor\Desktop\Requirment Team\FORD\Cariad_radar_Image\ff.xlsx')  #Doors Exported foreignID file
