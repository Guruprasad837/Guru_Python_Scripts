...
expected_filename_keyword = "MPCI_SW_SYS_OlderProblems_3Months_Security"
...
rtc_url = "https://rb-alm-14-p.de.bosch.com/ccm/web/projects/CentralComputingRack%20(CCM)#action=com.ibm.team.workitem.runSavedQuery&id=_lzEtIvFDEe-LqNoB04ZrZg"
...
if latest_csv_file:
    ...
    if file_size <= 1024:  # Check if file size is ≤ 1KB
        ...
        mail.To = "tarunkumar.bansal@in.bosch.com; prajaktamadhukar.wadhone@in.bosch.com"
        mail.CC = "senthilrajan.arunachalam@in.bosch.com; Manickam.Chokkalingam@in.bosch.com; NateshKumar.Kalasetty@in.bosch.com"
        mail.Subject = "[Automated] RTC Report: Security Problem Tickets Older Than 3 Months"

        # Updated Email Body
        mail.Body = f"""Hello Together,
    ...
    🔗 **[RTC Query - Security Problem Tickets Older Than 3 Months]( {rtc_url} )**  
