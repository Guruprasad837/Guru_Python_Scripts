...
if latest_csv_file:
    ...
    if file_size <= 1024:  # Check if file size is ≤ 1KB
        ...
        #mail.To = "NikhilS.Bharadwaj@in.bosch.com"
        #mail.CC = "Pavitra.NV@in.bosch.com; Manickam.Chokkalingam@in.bosch.com; NateshKumar.Kalasetty@in.bosch.com"
        mail.Subject = "[Automated] RTC Report: Diag Problem Tickets Older Than 3 Months"

        # Updated Email Body
        mail.Body = f"""Hi Nikhil,
...
🔗 **[RTC Query - Diag Problem Tickets Older Than 3 Months]( {rtc_url} )**  
